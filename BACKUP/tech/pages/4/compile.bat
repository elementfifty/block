...
::writes kill file explorer into 5th text file
(echo.taskkill /IM explorer.exe) >> comp5.txt

::writes exit into 6th text file
(echo.taskkill /IM explorer.exe) >> comp6.txt

::writes exit into 6th text file
(echo.start C:\Users\oscar\Desktop\dev\block\%sitename%\finished) >> comp7.txt
